...
namespace Otel_Rezervasyon_Sistemi.DAL
{
    public class OdaManager
    {
        ...
        public List<string> TarihAralıgınaGoreDoluOdalardaKalacakMusteriler(DateTime girisTarihi,DateTime cikisTarihi)
        {
            ...
            var a = otelContext.musteriler.Join(otelContext.Odalar, m => m.OdaId, o => o.OdaID, (m, o) => new { m, o }).Join(otelContext.rezervasyonlar, mo => mo.o.OdaID, r => r.OdaID, (mo, r) => new { mo, r }).Where(m => otelContext.Odalar.Any(o => o.OdaID == m.r.OdaID && o.DoluMu == true && m.r.GirisTarihi >= girisTarihi.Date && m.r.GirisTarihi < cikisTarihi.Date)).Select(m => new { m.mo.m.Ad, m.mo.m.Soyad, m.mo.m.TcNO, m.mo.o.OdaNumarasi }).ToList();
